        ...
        <div className="grid grid-cols-1 sm:grid-cols-12">
            <div className="col-span-7 place-self-center text-center sm:text-left">
                ...
                <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
                    ...
                    Quas, perferendis. Distinctio error odit corrupti consectetur
                    laboriosam velit tempore libero facere minima esse assumenda sint, pariatur
                    dolorem beatae nam doloribus harum.
                </p>
                <div>
            ...
            <div className="col-span-5 place-self-center mt-4 lg:mt-0">
                <div className=" bg-[#181818] w-[300px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
                    <Image 
